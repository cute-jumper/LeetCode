...
public class InsertInterval {
    public List<Interval> insert(List<Interval> intervals, Interval newInterval) {
        ...
        int index = 0;
        for (; index < intervals.size() && intervals.get(index).end < newInterval.start; index++) res.add(intervals.get(index));
        ...
        res.add(newInterval);
        for (; index < intervals.size(); index++) res.add(intervals.get(index));
        return res;
    }
}
